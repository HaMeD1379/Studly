...
const STRINGS = {
  ...
  VALIDATION: {
    ...
    PASSWORD_CHAR_REQUIREMENTS: "Password must be at least 8 characters long",
  ...
  MOCK: {
    ...
    MOCK_UPDATED_FULL_NAME: "Updated User",
    MOCK_UPDATED_BIO: "Updated bio text",
    MOCK_BIO: "This is my bio",
    MOCK_LONG_BIO: "x".repeat(501),
  },
  ...
  TEST: {
    ...
    RESET_PASSWORD_MISSING_PASSWORD: "should return 400 when password missing",
    ...
    SERVER_UTILS_SUCCESS: "should handle success with custom message and data",
    ...
    VALIDATE_MISSING_FIELDS: "should return 400 for missing required fields",
    ...
    VALIDATE_PROFILE_MISSING_USER_ID:
      "validateProfileUpdate - should return 400 when userId is missing",
    VALIDATE_PROFILE_BIO_TOO_LONG:
      "validateProfileUpdate - should return 400 when bio exceeds 500 characters",
    VALIDATE_PROFILE_SUCCESS:
      "validateProfileUpdate - should call next() when userId is provided",
    VALIDATE_PROFILE_BIO_UNDEFINED:
      "validateProfileUpdate - should call next() when bio is undefined",

    // Profile tests
    PROFILE_UPDATE_SUCCESS:
      "should return 200 when profile is updated successfully",
    PROFILE_UPDATE_MISSING_USER_ID: "should return 400 when user ID is missing",
    PROFILE_UPDATE_INVALID_BIO:
      "should return 400 when bio exceeds character limit",
    PROFILE_UPDATE_SUPABASE_ERROR: "should handle Supabase update error",
    PROFILE_UPDATE_UNEXPECTED_ERROR: "should handle unexpected update error",
    PROFILE_UPDATE_FULL_NAME_ONLY:
      "should update only full_name when bio is not provided",
    ...
    // Badges unit tests
    BADGES_REPOSITORY_FIND_ALL:
      "BadgesRepository - findAllBadges should return all active badges",
    BADGES_REPOSITORY_FIND_BY_ID:
      "BadgesRepository - findBadgeById should return specific badge",
    BADGES_REPOSITORY_USER_BADGES:
      "BadgesRepository - findUserBadges should return user badges",
    BADGES_REPOSITORY_CREATE:
      "BadgesRepository - createUserBadge should create new user badge",
    BADGES_REPOSITORY_UPDATE:
      "BadgesRepository - updateUserBadge should update existing badge",

    BADGES_SERVICE_GET_ALL:
      "BadgesService - getAllBadges should return all badges",
    BADGES_SERVICE_USER_BADGES:
      "BadgesService - getUserBadges should return user badges",
    BADGES_SERVICE_AWARD:
      "BadgesService - awardBadge should award badge to user",
    BADGES_SERVICE_PROGRESS:
      "BadgesService - updateBadgeProgress should update progress",
    BADGES_SERVICE_CHECK:
      "BadgesService - checkAndAwardBadges should check and award earned badges",
    BADGES_SERVICE_CALC_PROGRESS:
      "BadgesService - calculateBadgeProgress should calculate correct progress",
    BADGES_SERVICE_CALC_STREAK:
      "BadgesService - calculateStreak should calculate consecutive days",

    BADGES_CONTROLLER_GET_ALL:
      "BadgesController - getAllBadges should return all badges",
    BADGES_CONTROLLER_USER_BADGES:
      "BadgesController - getUserBadges should return user badges",
    BADGES_CONTROLLER_AWARD: "BadgesController - awardBadge should award badge",
    BADGES_CONTROLLER_CHECK:
      "BadgesController - checkUserBadges should check and award badges",

    // Integration tests
    BADGES_INTEGRATION_GET_ALL:
      "Badges API - GET /badges should return all badges",
    BADGES_INTEGRATION_USER_BADGES:
      "Badges API - GET /users/:userId/badges should return user badges",
    BADGES_INTEGRATION_AWARD:
      "Badges API - POST /badges/award should award badge",
    BADGES_INTEGRATION_CHECK:
      "Badges API - POST /users/:userId/badges/check should check badges",
  },
};

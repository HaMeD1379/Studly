...
describe('LeaderboardPage', () => {
  it('renders without data', () => {
    ...
    expect(screen.getByText('There is no data for this leaderboard')).toBeInTheDocument();
  });

  it('renders with data on study and You', () => {
    render(<LeaderboardPage rows={mockStudyTimeLeaderboard} type={LeaderboardPageType.StudyTime} />);
    ...
    for (const row of mockStudyTimeLeaderboard) {
      ...
      expect(screen.getByText(formatMinutesToHoursAndMinutes(row.totalMinutes))).toBeInTheDocument();
    }
  });

  it('renders with data on badges and You', () => {
    render(<LeaderboardPage rows={mockBadgesLeaderboard} type={LeaderboardPageType.Badges} />);
  ...
  it('renders unknown for displayName being null', () => {
    ...
    render(<LeaderboardPage rows={mockUnknown} type={LeaderboardPageType.StudyTime} />);
